...
export default function home(){
  return (
    <>
      <article className = "font-inter px-2 mt-48 min-h-screen text-2xl">
        ...
        <section className="grid grid-rows-[auto_200px] md:flex md:flex-row md:justify-center md:items-center md:px-12 ">
          ...
          <div className="w-full ">
            ...
            <p className="text-xl text-center font-bold text-[#0A8F9A] md:hidden">
              <span className = "text-black font-normal">How I paint My Feelings </span>
              Read more
            </p>
            <p className = "text-xl text-center md:hidden">Jayden Muriuki</p>
          </div>

          <div
                style={{ boxShadow: "0 4px 4px 0 #0A8F9A" }}
                className="mx-4 flex justify-center items-center gap-6 border rounded-[2rem] p-0 md:w-full md:h-52"
              >
                {/* Card 1 */}

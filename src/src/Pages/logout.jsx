    ...
    <article className = "min-h-screen mt-36 pt-6 bg-[#FAF5F5] md:bg-white px-4">
      ...
      <section className = "drop-shadow-[0_4px_4px_#000] rounded-2xl mb-6 py-4 bg-white px-6">
        ...
        <div className = "flex flex-row justify-evenly">
          <button className = "bg-[#00272B] rounded-xl py-2 text-white px-4 w-32">Back</button>
          <button className = "bg-[#E83C3C] rounded-xl py-2 text-white px-4 w-32">Sign Out</button>
        </div>
      </section>
      ...
      <section className="text-center">
       <button
        ...
        <div className = " px-10 font-martel flex justify-between">
          <a href="" className = "text-[#E83C3C]">Delete Account</a>
          <a href="" className = "text-[#E83C3C]">Sign Out</a>
        </div>
      </section>
    </article>
  )

...
export default function home(){
  return (
    <article className="mt-48">
      ...
      <form className = "flex flex-col px-10 md:px-56">
          <fieldset>
            ...
            className = " pl-4 py-2 pr-4 border bg-[#F5F5F5] w-full drop-shadow-green border-solid rounded-2xl border-2 mb-8"
            autocomplete/>
            ...
            id="email" 
            style = {{ boxShadow: "0 4px 4px 0 #0A8F9A" }}
            className = " pl-4 py-2 pr-4 border w-full bg-[#F5F5F5] drop-shadow-green border-solid rounded-2xl border-2 mb-8"
            autocomplete/>
